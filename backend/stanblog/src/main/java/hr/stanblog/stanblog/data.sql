INSERT INTO postgress_72f6.public.app_user ( email, first_name, last_name, user_role)
...
INSERT INTO postgress_72f6.public.apartment_building ( address, city, number_of_individual_apartments, zip_code)
VALUES ( 'Odranska 8', 'Zagreb', 23, 10000),
       ( 'Splitska 4', 'Split', 5, '21000'),
       ( 'Stjepana radica 42', 'Sibenik', 3, 22000);

INSERT INTO postgress_72f6.public.user_apartment_building ( is_representative, apartment_building_id, user_id)
VALUES ( true, 1, 2),
       ( false, 2, 3),
       ( false, 3, 4),
       ( false, 1, 1),
...
INSERT INTO postgress_72f6.public.discussion ( description, title, apartment_building_id, creator_user_id)
...
INSERT INTO postgress_72f6.public.comment ( author_id, discussion_id, content)
...
INSERT INTO postgress_72f6.public.voting (discussion_id,  negative_answer_label, pozitive_answer_label, title)
...
INSERT INTO postgress_72f6.public.user_voting (answer_pozitive, user_id, voting_id)
VALUES (true, 1, 1),
       (true, 2, 1),
       (true, 3, 1),
       (true, 4, 1);

INSERT INTO postgress_72f6.public.voting_user_votings(user_votings_id, voting_id)
VALUES (1, 1),
       (2, 1),
        (3, 1),
        (4,1);
